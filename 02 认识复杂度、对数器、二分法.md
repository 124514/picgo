# 02 认识复杂度、对数器、二分法
![](vx_images/265123723238788.png)
## 算法评价优劣的核心指标 
![](vx_images/69873823226655.png)
### 时间复杂度
![](vx_images/238160301231800.png)

![](vx_images/167854023246821.png)
常数操作 在算法中表示固定时间的操作 如图 1+1 和 170345456+45646的时间是一样的 
算术运算在算法中视为常数操作 
数组寻址 在算法中也视为常数操作
<mark>数组逻辑上是个连续区域</mark>
![](vx_images/567784323239490.png)
<mark>时间复杂度讨论的是  执行完 整个流程 常数操作的数量是个 什么级别的关系</mark>

## 选择排序
### 选择排序原理
![](vx_images/224064623236045.png)
时间复杂度 是o(n^2） 时间复杂度 只是比较的 最高次数项 不考虑常数项 不考虑系数

### 代码——选择排序
![](vx_images/310091001226027.png)
```java
...
![](vx_images/514714601243603.png)

## 插入排序 
### 插入排序时间复杂度
![](vx_images/446915501220813.png)
### 插入排序原理分析
![](vx_images/315634701237149.png)

### 代码——插入排序
![](vx_images/64554901230283.png)
```java
...
## 冒泡排序和插入排序时间复杂度上的区别
![](vx_images/206055701223317.png)
![](vx_images/534895701232264.png)
## 额外空间复杂度
![](vx_images/334175801225149.png)
![](vx_images/41215901225758.png)

## 算法时间复杂度一样 怎么比较好坏
![](vx_images/487805901252713.png)
<mark>进入拼常数阶段  放弃理论分析 理论分析涉及了太多的因素 直接大样本随机测试</mark>
## 面试 比赛 刷题中的最优解是什么
![](vx_images/145230202234926.png)

## 常见时间复杂度优劣排序
![](vx_images/452620202224224.png)
## 对数器
![](vx_images/44590402220614.png)
怎么试也是关键 
![](vx_images/209121802225769.png)
![](vx_images/285740402232704.png)
![](vx_images/340502237743.png)
### 对数器举例——测试插入排序 
![](vx_images/310780502239038.png)
#### 代码——主方法 
```java
// for test
...
### 大样本出错了 怎么检查的方法
![](vx_images/471880702240217.png)

## 二分法
![](vx_images/158352102231860.png)
![](vx_images/277841902235093.png)
本课后面会讲
![](vx_images/545972102222191.png)

### 有序数组中 找某个数是否存在
![](vx_images/273522202240234.png)
![](vx_images/200862302245989.png)
<mark>注意是 向下取整</mark>

#### 有序数组中 找某个数是否存在代码
![](vx_images/190552402246621.png)
![](vx_images/214312702237357.png)
```java
...
### 有序数组中 找>=某个数最左边的位置 
#### 原理讲解
![](vx_images/591802802230216.png)
![](vx_images/205672902249025.png)
#### 代码
![](vx_images/220913002244133.png)
<mark>注意 L<R和 L<=R的区别 
...
#### 原理分析
![](vx_images/314553802251644.png)
![](vx_images/549613802250655.png)
#### 局部最小的代码
![](vx_images/291313902237995.png)
```java
